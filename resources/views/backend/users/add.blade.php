          ...
          <section class="forms-basic">
            ...
            <div class="row  m-b-40">
              <div class="col-md-12">
				...
				{{ Form::open(array('url' => 'dashboard/users/add_action')) }}
           ...
           <legend>Add User</legend> 
						<div class="row">
							...
							<div class="form-group">
								...
								{{ Form::input('email', 'email','', ['class' => ' form-control', 'id' => '','required'=>'required' ]) }}
							</div>
							</div>
							<div class="col-md-4">
							<div class="form-group" >
								<label for="inputEmail" class="control-label">Name</label>
									{{ Form::input('text', 'name','', ['class' => 'form-control', 'id' => '','required'=>'required']) }}
							</div>
							</div>
							<div class="col-md-4">
							<div class="form-group" >
