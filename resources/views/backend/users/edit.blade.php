          ...
          <div id="errorwhileaddinguser" class="modal " tabindex="-1" >
            ...
            <div class="row  m-b-40">
              <div class="col-md-12">
				...
				{{ Form::open(array('url' => 'dashboard/users/update_action')) }}
				{{ Form::input('hidden', '_token',csrf_token(), ['class' => 'form-control', 'id' => '', ]) }}
				{{ Form::input('hidden', 'id',$users->id, ['class' => ' form-control', 'id' => '','required'=>'required']) }}
           ...
           <legend>Update User</legend> 
						<div class="row">
							...
							<div class="form-group" >
								<label for="inputEmail" class="control-label">Name</label>
									{{ Form::input('text', 'name',$users->name, ['class' => 'form-control', 'id' => '','required'=>'required']) }}
							</div>
							</div>
							<div class="col-md-4">
							<div class="form-group">
								<label for="inputEmail" class="control-label">Password</label>
								{{ Form::input('password', 'password','', ['class' => 'form-control', 'id' => '']) }}
							</div>
							</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-3 form-group">
									...
									<input type="text" name="zipcode" class="form-control" value="{{ $users->zipcode }}">
								</div>
								<div class="col-md-3 form-group">
					  ...
					  <div class="form-group" >
						...
						<a href="{{url('dashboard/users')}}" class="btn btn-sm btn-success" style="color:white">Back</a>
            </div>
            </fieldset>
                  </div>
				  {{ Form::close() }}
