				...
				<fieldset>
				      <legend> 
				      	...
				      	<div class="col-md-6" style="padding:0px">   
				      		...
				      		<h3 style="padding-bottom:0px;border:none;font-size:20px;color:black; padding: 12px; " class="table-title p-20">Media List 
				      			<a href="{{url('dashboard/media/add')}}">
				  ...
				  <div class="table-responsive white">
                   <table class="table table-full table-full-small">
                      ...
                      <tbody id="myTable">
											  ...
											  <tr>
												  <td style="width:100%">
												  	<img src="{{url('public/uploads/images/'.$medi->name)}}" style="width:100px">
												  </td>
												 	<td>{{url('public/uploads/images/'.$medi->name)}}</td>
						  					  <td >
						  					  	

													  <a   onclick="delete_record('{{$medi->id}}');"><i class="md md-delete red darken-2 icon-color icon-color-custom"></i></a>
												  </td>
                        </tr>
                        @endforeach
					  					</tbody>
...
function delete_it(){
	if(single_delete==='1'){
		var final_url=APP_URL+'/dashboard/media/delete/'+del_id;
