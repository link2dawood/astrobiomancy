          ...
          <section class="forms-basic">
            ...
            <div class="row  m-b-40">
              ...
              <div class="col-md-12">
				...
				{{ Form::open(array('url' => 'dashboard/category/update_action')) }}
           ...
           <legend>Edit Category</legend> 
						<div class="row">
							...
							<div class="form-group" >
								<label for="inputEmail" class="control-label">Name</label>
									{{ Form::input('text', 'name',$category->name, ['class' => 'form-control', 'id' => '']) }}
									{{ Form::input('hidden', 'id',$category->id, ['class' => 'form-control', 'id' => '']) }}
					  ...
					  <div class="form-group" >
						...
						<a href="{{url('dashboard/category')}}" class="btn btn-sm btn-success" style="color:white">Back</a>
