...
<button  class="btn btn-sm btn-primary hide-mobile button-click-sidebar" style=" margin-left: 4%; margin-top: 1%;"><i class="md md-view-module"></i></button>
<nav class="navbar navbar-default navbar-fixed-top" >
    <div class="container-fluid">
        <div class="navbar-header pull-left">
            <button type="button" class="navbar-toggle pull-left m-15 toggle-mobile" data-activates=".sidebar"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
            <ul class="breadcrumb">
                <li><a href="#/">Materialism</a></li>
                <li class="active">Dashboard</li>
            </ul>
        </div>
        <ul class="nav navbar-nav navbar-right navbar-right-no-collapse d-none">
