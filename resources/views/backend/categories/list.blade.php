				...
				<fieldset>
				      <legend> 
				      	...
				      	<div class="col-md-6" style="padding:0px">   
				      		...
				      		<h3 style="padding-bottom:0px;border:none;font-size:20px;color:black; padding: 12px; " class="table-title p-20">Categories 
                   ...
                   <table class="table table-full table-full-small">
                      ...
                      <tbody id="myTable">
											  ...
											  <tr>
						  					  ...
						  					  <td >
						  					  	<a href="{{url('dashboard/category/edit/'.$category->id)}}"><i class="md md-edit light-blue lighten-1 icon-color icon-color-custom"></i></a>

													  <a   onclick="delete_record('{{$category->id}}');"><i class="md md-delete red darken-2 icon-color icon-color-custom"></i></a>
												  </td>
                        </tr>
                        @endforeach
					  					</tbody>
...
function delete_it(){
	if(single_delete==='1'){
		var final_url=APP_URL+'/dashboard/category/delete/'+del_id;
