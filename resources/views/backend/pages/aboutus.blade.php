  ...
  <main>
	...
	<div class="main-container">
       ...
       <div class="well white">
				...
				<form action="{{ url('/dashboard/pages/about_save') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="form-group" >
								<label for="inputEmail" class="control-label">Main Heading</label>
									{{ Form::input('text', 'main_heading', $aboutus->main_heading, ['class' => 'form-control', 'id' => '']) }}
							</div>
							</div>
							<div class="col-md-4">
							<div class="form-group" >
								<label for="inputEmail" class="control-label">Second Heading</label>
									{{ Form::input('text', 'second_heading',$aboutus->second_heading, ['class' => 'form-control', 'id' => '']) }}
							</div>
							</div>
							...
							<label for="inputEmail" class="control-label">Content</label>
								<textarea class="form-control" name="description" id="content" placeholder="Content">{{$aboutus->description}}</textarea>
							</div>
							</div>
