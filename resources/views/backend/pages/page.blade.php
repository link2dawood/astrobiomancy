						...
						<div class="row">
							...
							<div class="form-group" >
								<label for="inputEmail" class="control-label">Main Heading</label>
									{{ Form::input('text', 'main_heading', $page->main_heading, ['class' => 'form-control', 'id' => '']) }}
							</div>
							</div>
							<div class="col-md-4">
							<div class="form-group" >
								<label for="inputEmail" class="control-label">Second Heading</label>
									{{ Form::input('text', 'second_heading',$page->second_heading, ['class' => 'form-control', 'id' => '']) }}

									{{ Form::input('hidden', 'id',$page->id, ['class' => 'form-control', 'id' => '']) }}
							</div>
							</div>
							...
							<label for="inputEmail" class="control-label">Content</label>
								<textarea class="form-control" name="description" id="content" placeholder="Content">{{$page->description}}</textarea>
							</div>
							</div>
